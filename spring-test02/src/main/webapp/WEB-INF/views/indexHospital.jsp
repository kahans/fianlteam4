...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="/dashBoard/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="/dashBoard/fonts/font-awesome/css/font-awesome.min.css" />

    <link id="themecss" rel="stylesheet" type="text/css" href="http://www.shieldui.com/shared/components/latest/css/light/all.min.css" />

    <link rel="stylesheet" type="text/css" href="/dashBoard/css/theme.css" />
...
<body>
 <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="nav nav-list nav-list-expandable nav-list-expanded">
                        <a><i class="fa fa-user"></i> 접수실 <span class="caret"></span></a>
                        <ul class="nav navbar-nav">
                            <li><a href="datagrid.html"><i class="fa fa-table"></i> 차트</a></li>
                            <li><a href="editor.html"><i class="fa fa-edit"></i> 몰ㄹ라</a></li>
                        </ul>
                    </li>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <textarea rows="20" cols="40" class="col-md-6"></textarea>
                                ...
                                <ul class="media-list">
                                    <li class="media">
                                        <div class="media-left">
                                            <img class="media-object" src="dashBoard/images/user1.jpg" style="width:64px; height:64px; border-radius:50%; border:solid 1px #E1E1E1;" />
                                        </div>
                                    ...
                                    <li class="media">
                                        <div class="media-left">
                                            <img class="media-object" src="dashBoard/images/user2.jpg" style="width:64px; height:64px; border-radius:50%; border:solid 1px #E1E1E1;" />
                                        </div>
                                        <div class="media-body">
    ...
    <script type="text/javascript" src="/dashBoard/js/jquery-1.10.2.min.js"></script>
